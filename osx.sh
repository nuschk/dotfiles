...
sudo scutil --set ComputerName "Sprossomat"
sudo scutil --set HostName "Sprossomat.local"
sudo scutil --set LocalHostName "Sprossomat"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Sprossomat"
